[![Run App Harris, Logan](https://github.com/LoganLHarris/GithubActionsLab/actions/workflows/ci.yml/badge.svg)](https://github.com/LoganLHarris/GithubActionsLab/actions/workflows/ci.yml)
